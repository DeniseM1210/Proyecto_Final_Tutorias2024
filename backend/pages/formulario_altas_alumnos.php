...
<body>
    ...
    <div class="container">
        <h2>Agregar Alumno</h1>
            ...
            (isset($_SESSION['insercion_correcta']) && $_SESSION['insercion_correcta'] == true )?'content':'none' ;?>;" class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <form action="../controllers/procesar_altas_alumnos.php" method="POST">
                ...
                <div class="form-row">
                    ...
                    <label for="inputEmail4">Numero de Telefono</label>
                        <input type="tel" class="form-control" id="caja_tel" name="caja_tel" placeholder="# de Telefono" minlength="10" maxlength="10"
                        value="<?php 
